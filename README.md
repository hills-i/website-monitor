...
- **AI-Powered Summaries**: Uses OpenAI API to generate Japanese summaries of detected changes
...
6. **AI Analysis**: Sends diffs to OpenAI for intelligent summarization in Japanese
